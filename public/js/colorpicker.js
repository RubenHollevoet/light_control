var inp1 = document.querySelector('.js-cp-hue');
var inp2 = document.querySelector('.js-cp-sat');
var inp3 = document.querySelector('.js-cp-lig');
var txt = document.querySelector('.js-cp-output');
var view = document.querySelector('.js-cp-view');
var copy = document.querySelector('.js-cp-copy');
...
function update() {
    ...
    str = str.split(",");
    console.log(str);
    txt.value = (str[0] * 256 * 256 + str[1] * 256 + str[2] * 1);
    var hex = [0, 0, 0];
    ...
    hex = "#" + hex.join("");
    document.querySelector('.js-cp-hex').innerHTML = hex;
}
update();
inp1.oninput = update;
inp2.oninput = update;
